---
name: four-x-market-radar
description: "Daily learning and market-narrative radar for four Chinese finance/stock X accounts: @freearkshaw, @dacefupan, @derek03275486, and @andrew_fdwt. Use when the user asks to monitor these X accounts, learn their daily content, summarize new market themes, compare account views, or map their posts to A-share/HK/US/Japan/Korea stocks, sectors, catalysts, AI, semiconductor, commodity, macro, or sentiment analysis."
---

# Four X Market Radar

Use this skill to maintain and apply a daily knowledge base for four tracked X accounts:

- `freearkshaw`: `https://x.com/freearkshaw?s=21`
- `dacefupan`: `https://x.com/dacefupan?s=21`
- `derek03275486`: `https://x.com/derek03275486?s=21`
...
```powershell
python C:\Users\lixue\.codex\skills\four-x-market-radar\scripts\update_four_x_market_radar.py --skill-dir C:\Users\lixue\.codex\skills\four-x-market-radar
```
