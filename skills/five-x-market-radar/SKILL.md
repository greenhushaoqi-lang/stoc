---
name: five-x-market-radar
description: "Daily learning and market-narrative radar for five Chinese finance/stock X accounts: @aleabitoreddit, @agujiaofu, @txbs888999, @bmcj888, and @qingfengjianzx. Use when the user asks to monitor these X accounts, learn their daily content, summarize new market themes, compare account views, or map their posts to A-share/HK/US/Japan/Korea stocks, sectors, catalysts, AI, semiconductor, commodity, macro, or sentiment analysis."
---

# Five X Market Radar

Use this skill to maintain and apply a daily knowledge base for five tracked X accounts:

- `aleabitoreddit`: `https://x.com/aleabitoreddit?s=21`
- `agujiaofu`: `https://x.com/agujiaofu?s=21`
- `txbs888999`: `https://x.com/txbs888999?s=21`
- `bmcj888`: `https://x.com/bmcj888?s=21`
- `qingfengjianzx`: `https://x.com/qingfengjianzx?s=21`
...
```powershell
python C:\Users\lixue\.codex\skills\five-x-market-radar\scripts\update_five_x_market_radar.py --skill-dir C:\Users\lixue\.codex\skills\five-x-market-radar
```
